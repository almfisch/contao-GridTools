...
$GLOBALS['BE_MOD']['gridtools']['gridtools_config'] = array
(
	'tables' => array('tl_gridtools'),
    'icon' => 'system/modules/GridTools/assets/icon_config.gif'
);

$GLOBALS['BE_MOD']['gridtools']['gridtools_helper'] = array
(
	'callback'   => 'GridToolsHelper',
    'icon' => 'system/modules/GridTools/assets/icon_helper.gif'
);
...
$GLOBALS['BE_FFL']['gridContent'] = 'GridContent';
...
if(TL_MODE === 'BE')
{
	$GLOBALS['TL_HOOKS']['parseBackendTemplate'][] = array('GridToolsBackend', 'backButton');
}

if(TL_MODE === 'FE')
{
	$GLOBALS['TL_HOOKS']['getContentElement'][] = array('GridToolsFrontend', 'filterCe');
}
